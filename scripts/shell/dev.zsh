# ============================================================
# gjo-se.com — Dev Helper
# ------------------------------------------------------------
# Shell-Hilfsfunktionen für den Docker-basierten Dev-Workflow.
# Sourcen mit: source scripts/shell/dev.zsh
#
# Hinweis: Das Projekt läuft ausschließlich via Docker.
# start_be / start_fe entfallen – der docker-compose.override.yml
# stellt Hot-Reload für Backend und Frontend bereit.
# ============================================================
